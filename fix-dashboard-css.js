...
// Ler o arquivo HTML do dashboard
const htmlPath = path.join(__dirname, 'out/dashboard/index.html');
...
if (headMatch) {
  ...
  console.log('CSS injetado com sucesso no dashboard.html!');
} else {
  console.log('Tag <head> não encontrada no dashboard');
}
